"""OpenClaw bridge for integrating with OpenClaw planner."""
...
class OpenClawBridge:
    """Bridge for communicating with OpenClaw planner."""
    ...
    def __init__(
        ...
        try:
            ...
            self.client = None
            print("Warning: anthropic package not installed. Bridge will be a no-op.")
    ...
    def propose_actions(
        ...
        if self.client is None:
            ...
            return PlannerResult(
                actions=[],
                raw_output="Anthropic client not available",
        ...
        try:
            ...
            error_msg = f"Error calling OpenClaw: {e}"
    ...
    def _build_prompt(self, context: PlannerContext) -> str:
        ...
        prompt_parts = [
            ...
            "",
            "Based on this context, propose the next actions. Return only JSON.",
            "",
            "Use this schema:",
...
class MockOpenClawBridge:
    ...
    def propose_actions(self, context: PlannerContext, **kwargs: Any) -> PlannerResult:
        ...
        return PlannerResult(
            actions=[],
            raw_output="Mock bridge - no actions proposed",
            timestamp=datetime.utcnow().isoformat() + "Z",
        )
